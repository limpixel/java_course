...
### Proses Penggunaan Beam
``` 
begin 

    numeric nUser, nBeam, nBeamTrack nBeamStatus, nBeamDering ,nSaldo, nBattery, nQrCode, nTarif = 700, nWaktu, 

    display "Selamat datang di beam"

    accept nUser, nBeam, nBeamId ,nBeamStatus, nBeamDering ,nSaldo, nBattery, nTarif

    label Home : 
        display nBeamTrack, nSaldo, 

    switch (nUser, nBeam, nBeamTrack)
        begin 
            case HOME : 
                begin 
                    display nBeam 
